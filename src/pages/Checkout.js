...
function Checkout() {
  ...
  //to pass selected address and payment method to order...
  ...
  const handleAddress = (e) => {
    ...
    setSelectedAddress(user.addresses[e.target.value]); // user.addresses[1]
  };
            ...
            <div className="mx-auto mt-12 bg-white max-w-7xl px-2 sm:px-2 lg:px-2">
              ...
              <div className="border-t border-gray-200 px-2 py-6 sm:px-2">
                ...
                <div className="mt-6">
                  <div
                    onClick={handleOrder}
                    className="flex items-center cursor-pointer justify-center rounded-md border border-transparent bg-gray-600 px-6 py-3 text-base font-medium text-white shadow-sm hover:bg-gray-700"
                  >
                    Order Now
                  </div>
                </div>
